...
export declare const makeSetFieldDecoratorFactory: (type: FieldType) => (values: string[], tsName: string, options?: Pick<SetOptions, "description" | "options" | "primary" | "default" | "deprecation">) => ({ constructor: { name: entity } }: any, name: string) => void;
